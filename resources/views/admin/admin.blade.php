...
<body class="hold-transition sidebar-mini">
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="card">
                                ...
                                <!-- Notif -->
                                <div class="card-header">
                                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#buatModal" data-whatever="@mdo">Daftar Admin</button>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
                            ...
                            <div class="modal fade" id="buatModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <form action="{{ route('admins-view.store') }}" method="POST" enctype="multipart/form-data">
                                            {{csrf_field()}}
                            ...
                            <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <form action="{{ route('admins-view.update', $item->id) }}" method="POST" enctype="multipart/form-data">
                                            {{csrf_field()}}
                                            {{method_field("PUT")}}
                                            <div class="modal-body">
    ...
    <script>
        $('body').on('click', '#edit-admin', function() {
            ...
            $.get('admins-view/' + admin_id + '/edit', function(data) {
