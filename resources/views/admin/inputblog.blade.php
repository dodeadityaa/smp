                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-info">
                                ...
                                <!-- Notif -->
                                <!-- form start -->
                                <form class="form-horizontal" action="{{ route('blog-view.store') }}" enctype="multipart/form-data" method="post">
                                    {{csrf_field()}}
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <select name="categori" id="categori" class="form-control input-lg dynamic1" data-dependent="KabupatenKota" required>
                                        ...
                                        <div class="form-group row">
                                            <label for="inputEmail3" class="col-sm-2 col-form-label" required>Isi</label>
                                            <div class="col-sm-10">
                                                <textarea id="summernote" name="blog">
