                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-info">
                                ...
                                <!-- Notif -->
                                <!-- form start -->
                                <form class="form-horizontal" action="{{ route('pengumuman-view.store') }}" enctype="multipart/form-data" method="post">
                                    {{csrf_field()}}
                                    <div class="card-body">
                                        <div class="form-group row">
                                            <label for="inputEmail3" class="col-sm-2 col-form-label">Judul</label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" name="judul_pengumuman" id="judul_pengumuman" placeholder="Judul Pengumuman" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea id="summernote" name="detail_pengumuman" required>
                                                </textarea>
                                            </div>
                                        </div>
                                    </div>
