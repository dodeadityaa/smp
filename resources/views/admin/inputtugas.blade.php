                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-info">
                                ...
                                <!-- Notif -->
                                <!-- form start -->
                                <form class="form-horizontal" action="{{ route('tugas-view.store') }}" enctype="multipart/form-data" method="post">
                                    {{csrf_field()}}
                                    <div class="card-body">
                                        <div class="form-group row">
                                            <label for="inputEmail3" class="col-sm-2 col-form-label">Judul Tugas</label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" name="judul_tugas" id="judul_tugas" placeholder="Masukan Judul Tugas" required>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="inputEmail3" class="col-sm-2 col-form-label" required>Detail Tugas</label>
                                            <div class="col-sm-10">
                                                <textarea id="summernote" name="detail_tugas">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="date" class="form-control" name="tgl" id="tgl" placeholder="Masukan Tanggal" required>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="file" class="form-control" id="upload_tugas" name="upload_tugas" required>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- /.card-body -->
