                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="card">
                                ...
                                <!-- Notif -->
                                <div class="card-header">
                                    <a href="{{ route('tugas-view.create') }}" class="btn btn-primary">Input Tugas Baru</a>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{$item->tgl}}</td>
                                                <td><a href="{{ route('tugas-view.edit',$item->id) }}" class="btn btn-sm btn-success">Edit</a>
                                                    <form action="{{ route('tugas-view.destroy', $item->id) }}" method="post">
                                                        {{ csrf_field() }}
                                                        {{ method_field('DELETE') }}
                                                        <button class="btn btn-sm btn-danger" type="submit" onclick="return confirm('Yakin ingin menghapus data {{ $item->judul_tugas }} ?')">Hapus</button>
                                                    </form>
                                                </td>
                                            </tr>
